...
public class WrongSorttheJumbledNumbers {
...
//		}
		...
		for (int i = 0; i < nums.length; i++) {
			/*
			 * int temp = nums[i]; int num = 0; while (temp != 0) { num = num * 10 +
			 * map.get(temp % 10); temp /= 10; } int rev = 0; while (num != 0) { rev = rev *
			 * 10 + num % 10; num /= 10; }
			 * 
			 * sums[i] = rev;
			 */
			...
			while (temp != 0) {
				...
				sum = newD * (int) Math.pow(10, pow) + sum;
				temp = temp / 10;
				pow++;
			}
